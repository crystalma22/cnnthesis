...
# ---------------------------------------------------------------------------
# Table 5: FOMC event study (announcement day, reaction, intermediate)
# ---------------------------------------------------------------------------
print("Table 5: FOMC event study windows")
...
save_table(
    ...
    "CNN performance around FOMC announcements. *** p<0.01, ** p<0.05, * p<0.10.",
    "tab:fomc_event",
...
# ---------------------------------------------------------------------------
# Table 9: Timeline within FOMC week (pre vs announcement vs post)
# ---------------------------------------------------------------------------
print("Table 9: Pre vs post FOMC predictability")
...
save_table(
    ...
    "Predictability around FOMC announcements. EW and VW high-minus-low spreads by window.",
    "tab:fomc_timeline",
